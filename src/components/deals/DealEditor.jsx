...
const DealEditor = ({ deal, onSave, onCancel }) => {
	...
	const [editedLeaseOrSale, setEditedLeaseOrSale] = useState(
		deal.leaseOrSale || ""
	)
	...
	const [editedLeaseExpiration, setEditedLeaseExpiration] = useState(
		deal.leaseExpiration || ""
	)
	const [editedAdditionalCharges, setEditedAdditionalCharges] = useState(
		deal.additionalCharges || ""
	)
